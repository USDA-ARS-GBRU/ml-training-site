...
Download the this conda environment file [windows64-mlenv.yaml](/ml-training-site/assets/windows64-mlenv.yaml).
...
```
conda create -n mlenv python=3.7 pandas numpy seaborn jupyter scikit-learn
conda activate mlenv
